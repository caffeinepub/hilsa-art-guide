...
export default function Results() {
  ...
  // Validate jobId: must be present and non-empty
  const isValidJobId = !!jobId && jobId.trim() !== "";

  // Safely convert to BigInt only when valid
  const jobIdBigInt = isValidJobId ? BigInt(jobId!) : null;
  ...
  // The gallery handles per-stage loading states internally
